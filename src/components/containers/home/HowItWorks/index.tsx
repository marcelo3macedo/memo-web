          ...
          <Items>
            <Item>
              <ItemArea>
                ...
                <ItemDescription>
                  {t('home.blockHowItWorks.search.subTitle')}
                </ItemDescription>
              </ItemArea>
            </Item>
            <Item>
              <ItemArea>
                ...
                <ItemDescription>
                  {t('home.blockHowItWorks.add.subTitle')}
                </ItemDescription>
              </ItemArea>
            </Item>
            <Item>
              <ItemArea>
                ...
                <ItemDescription>
                  {t('home.blockHowItWorks.review.subTitle')}
                </ItemDescription>
              </ItemArea>
            </Item>
            <Item>
              <ItemArea>
                ...
                <ItemDescription>
                  {t('home.blockHowItWorks.repeat.subTitle')}
                </ItemDescription>
              </ItemArea>
            </Item>
          </Items>
