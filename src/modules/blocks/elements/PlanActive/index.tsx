...
import { Wrapper, Container, Title, Details, Description, Info } from "./styles"
...
export default function PlanActive() {
  ...
  const planExpiresAt = userRole && userRole.expiresAt ? 
    `${t('plans.details.expiresAt')} ${formatTimeAsString(userRole.expiresAt)}` : null
