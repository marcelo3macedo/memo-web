...
export default function Routes() {
  ...
  return (
    <Switch location={location}>
      <Router
        path={PATH_SESSIONPUBLIC + '/:path/:id'}
        component={SessionPublic}
        layout={Layouts.Main}
        isPublic={true}
      />
      ...
      <Router
        path={PATH_GALLERY + '/:search'}
        component={Gallery}
        layout={Layouts.Main}
      />
      <Router path={PATH_GALLERY} component={Gallery} layout={Layouts.Main} />
      <Router
        path={PATH_GALLERYDECK + '/:path'}
        component={GalleryDeck}
      ...
      />
      <Router
        path={PATH_DECK + '/:path/:id'}
        component={Deck}
        layout={Layouts.Main}
      />
      <Router
        path={PATH_EDITSESSION}
      ...
      />
      <Router
        path={PATH_TERMS_CONDITIONS}
        component={TermsConditions}
        layout={Layouts.Main}
      />
      <Router
        path={PATH_SESSION + '/:id'}
        component={Session}
        layout={Layouts.Main}
      />
      <Router
        path={PATH_FEATURED + '/:id'}
        component={Featured}
        layout={Layouts.Main}
      />
      ...
      <Router
        path={PATH_CREATESESSION}
        component={CreateSession}
        layout={Layouts.Main}
      />
      <Router
        path={PATH_INTEGRATION_TELEGRAM + '/:id'}
        component={IntegrationTelegram}
        layout={Layouts.Main}
      />
      <Router
        path={PATH_INTEGRATION_TELEGRAM}
        component={IntegrationTelegram}
        layout={Layouts.Main}
      />
      <Router
        path={PATH_INTEGRATION}
        component={Integration}
        layout={Layouts.Main}
      />
      <Router
        path={PATH_TUTORIAL_CARDS}
        component={TutorialCards}
        layout={Layouts.Main}
      />
      <Router path={PATH_TUTORIAL} component={Tutorial} layout={Layouts.Main} />
      <Router
        path={PATH_PLANS + '/:type'}
        component={PlanType}
        layout={Layouts.Main}
      />
